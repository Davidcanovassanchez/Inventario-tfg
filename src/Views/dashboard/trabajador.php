...
<div id="sidebar">
    <a href="/tfg/Inventory-tfg/src/Controllers/productoController.php?accion=listar">📦 Ver productos</a>
    <a href="../productos/escanear_qr.php">🔄 Actualizar stock (QR)</a>
...
<div id="main-content" class="container">
    ...
    <div class="d-flex flex-wrap justify-content-center gap-3 mt-4">
        <div class="card card-clickable text-white bg-primary" style="width: 18rem;" 
             onclick="window.location='/tfg/Inventory-tfg/src/Controllers/productoController.php?accion=listar';">
        ...
        <div class="card card-clickable text-white bg-info" style="width: 18rem;" 
             onclick="window.location='/tfg/Inventory-tfg/src/Controllers/productoController.php?accion=historial';">
            <div class="card-body text-center">
        ...
        <div class="card card-clickable text-white bg-success" style="width: 18rem;" 
             onclick="window.location='../productos/escanear_qr.php';">
            <div class="card-body text-center">
